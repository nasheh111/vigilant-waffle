...
DEMO = {
    DEMO_QUESTIONS[0]: dict(
        answer=(
            ...
            "具备 3 年 NLP 与大模型应用开发经验，2024.10 起任职东尼电子股份有限公司大模型应用工程师，专注 RAG 与 Agent 方向，"
    ...
    DEMO_QUESTIONS[1]: dict(
        answer=(
            ...
            "5. **生成**：证据充分的上下文交给 Qwen2.5-14B 生成排查建议，回答保持简洁自然。\n\n"
...
FALLBACK = (
    "这个问题我确实没有直接相关的经历，不敢硬答。我实际做过的主要是工业设备 RAG、LangGraph Agent 编排、"
    "文档解析和工程化部署这些方向。如果岗位需要这块能力，我的做法是先查官方文档和成熟案例，再拿一个小 demo 验证。"
    "\n\n你可以换个方向继续考察：项目经历、RAG 链路、Agent 编排、指标口径我都能详细讲。"
)
